...
<div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Actividades en este proyecto</h5>
        ...
        <div class="card-header card-header-primary">
            <div style="display: flex; flex-wrap: wrap">
                <div class="col-md-8">
                    <a href="{{route('TypeActivity', $id_proyecto)}}" class="btn btn-info"><i class="material-icons">check</i>Agregar Nueva Actividad <i class="material-icons">add_circle_outline</i></a>
                </div>
{{--                @if($rol == 4 || $rol == 7)--}}
{{--                    <div class="col-md-4">--}}
{{--                        <div class="form-group">--}}
{{--                            <label class="text-dark">Filtrar Gerencia</label>--}}
